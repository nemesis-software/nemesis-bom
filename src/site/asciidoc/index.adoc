...
The nemesis platform bom (Bill Of Materials) specifies all the dependencies for the platform. It inherits the link:http://docs.spring.io/platform/docs/2.0.1.RELEASE/reference/htmlsingle/[spring platform bom version 2.0.1.RELEASE] and includes
