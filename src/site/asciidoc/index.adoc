...
The nemesis platform bom (Bill Of Materials) specifies all the dependencies for the platform. It inherits the link:http://docs.spring.io/platform/docs/1.1.4.RELEASE/reference/htmlsingle/[spring platform bom version 1.1.4.RELEASE] and includes
